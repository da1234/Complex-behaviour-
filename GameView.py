...
class GameModel(Model):
    ...
    def __init__(self, N, width, height,SINGLE=False,FIVEWAY=False,SEVENWAY=False,NINEWAY=False):
        self.num_agents = N
        ...
        if SINGLE:
            ...
            self.SP = []
            self.W = []
            self.all_strats = [self.R,self.P,self.S, self.SP, self.W]
            ...
            self.A = []
            self.F = []
            self.all_strats = [self.R,self.P,self.S, self.SP, self.W, self.A, self.F]
            ...
            self.G = []
            self.H = []
            self.all_strats = [self.R,self.P,self.S, self.SP, self.W, self.A, self.F, self.G, self.H]
        ...
        for i in range(self.num_agents):
            ...
            if SINGLE == True:
                ...
                a = GameAgent(i, self,strat,SINGLE,FIVEWAY,SEVENWAY,NINEWAY)
                self.schedule.add(a)
                ...
                strat = random.randint(1,7)
                a = GameAgent(i, self,strat,SINGLE,FIVEWAY,SEVENWAY,NINEWAY)
                self.schedule.add(a)

                self.datacollector = DataCollector(model_reporters={"strat1 cnt":count_strat1,"strat2 cnt":count_strat2,"strat3 cnt":count_strat3, "strat4 cnt":count_strat4, "strat5 cnt":count_strat5, "strat6 cnt":count_strat6, "strat7 cnt":count_strat7,
                                                                    "takeOver":takeOver})
            elif NINEWAY == True:
                ...
                #print(strat1,strat2)
                a = GameAgent(i, self,[strat1,strat2],SINGLE,FIVEWAY,SEVENWAY,NINEWAY)
                self.schedule.add(a)
...
class GameAgent(Agent):
    ...
    """ An RPS player """
    def __init__(self, unique_id, model,strategy,single,fiveway,sevenway,nineway):
        super().__init__(unique_id, model)

        self.score= 0
        self.id = unique_id
        self.single = single
        self.fiveway = fiveway
        self.sevenway = sevenway
...
#                    self.set_score(current_score +1)
 ...
 #           current_score = self.get_score()
            ...
            if p_strat == 1:
                if n_strat == 2 or n_strat == 5 or n_strat == 6:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 3 or n_strat == 4 or n_strat == 7:
                    self.results[indx] += 1

            elif p_strat == 2:
                if n_strat == 3 or n_strat == 4 or n_strat == 7:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 1 or n_strat == 5 or n_strat == 6:
                    self.results[indx] += 1

            elif p_strat == 3:
                if n_strat == 1 or n_strat == 5 or n_strat == 7:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 2 or n_strat == 4 or n_strat == 6:
                    self.results[indx] += 1

            elif p_strat == 4:
                if n_strat == 1 or n_strat == 3 or n_strat == 7:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 2 or n_strat == 5 or n_strat == 6:
                    self.results[indx] += 1

            elif p_strat == 5:
                if n_strat == 2 or n_strat == 4 or n_strat == 6:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 1 or n_strat == 3 or n_strat == 7:
                    self.results[indx] += 1

            elif p_strat == 6:
                if n_strat == 2 or n_strat == 3 or n_strat == 4:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 1 or n_strat ==5 or n_strat == 7:
                    self.results[indx] += 1

            elif p_strat == 7:
                if n_strat == 1 or n_strat == 5 or n_strat == 6:
 #                   self.set_score(current_score -1)
                    self.results[indx] -= 1
                elif n_strat == 2 or n_strat == 3 or n_strat == 4:
                    self.results[indx] += 1
...
##
# for size in range(2,12,2):
# ##
#    hist_data = get_hist_data(True,size,size,size**2)
#    np.savetxt('/Users/talhaahmed/Desktop/bsc/data/single/' + str(size)+'.txt',hist_data)
# ##
